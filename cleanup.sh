...
# Шаг 3.5: Удаление файлов RBAC и CRD (они содержат системные ресурсы и конфликтуют)
remove_files "**/cluster-scoped/clusterroles.yaml" "Удаление файла ClusterRoles (содержит системные ресурсы)"
remove_files "**/cluster-scoped/clusterrolebindings.yaml" "Удаление файла ClusterRoleBindings (содержит системные ресурсы)"
remove_files "**/cluster-scoped/customresourcedefinitions.yaml" "Удаление файла CustomResourceDefinitions (конфликтует с существующими)"
remove_files "**/cluster-scoped/crds.yaml" "Удаление файла CRDs (конфликтует с существующими)"
