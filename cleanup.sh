...
# Шаг 6.5: Очистка аннотаций в CRD файлах (они часто слишком большие)
apply_yq "**/cluster-scoped/customresourcedefinitions.yaml" \
  '.items[].metadata.annotations = {}' \
  "Очистка аннотаций в CRD файлах (замена на пустой объект)"

apply_yq "**/cluster-scoped/crds.yaml" \
  '.items[].metadata.annotations = {}' \
  "Очистка аннотаций в crds.yaml"
